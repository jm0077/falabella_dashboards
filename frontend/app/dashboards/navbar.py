                ...
                dbc.Collapse(
                    dbc.Nav(
                        [
                            ...
                            dbc.NavItem(dbc.NavLink([html.Img(src="/static/img/user-icon.svg", height="20px", className="me-2 d-none d-md-inline"), "Mi Cuenta"], href="/dashboard/my-account/", id="navbar-account")),
