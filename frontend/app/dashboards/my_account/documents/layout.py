...
def create_documents_layout():
    document_options = [
        ...
        {"title": "Consulta de Documentos", "description": "Revisa y descarga tus documentos almacenados", "icon": "documentos.svg", "href": "/dashboard/my-account/documents/download/"},
    ]
